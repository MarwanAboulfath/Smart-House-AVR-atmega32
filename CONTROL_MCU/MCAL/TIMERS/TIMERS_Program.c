...
static void(*TIMERS_ptfCallBackFuncArr[8])(void)={NULL_ptr};
...
void TIMER0_voidSetPrescaler(u8 copy_u8Prescaler)
{
	/*Set the Required Prescaler*/
	TCCR0 &= TIMER_PRESCALER_MASK ;
...
void TIMER2_voidSetPrescaler(u8 copy_u8Prescaler)
{
	/* Set the Required Prescaler */
	TCCR2 &= TIMER_PRESCALER_MASK ;
...
u8 TIMER_u8SetCallBack(void(*copy_ptfCallBackFunc)(void),u8 copy_u8VectorID)
{
	...
	if((copy_u8VectorID<=TIMER0_OVF_VECTOR_ID) && (copy_u8VectorID>=TIMER2_CTC_VECTOR_ID))
	{
		...
		if(copy_ptfCallBackFunc!= NULL_ptr)
		{
...
{
	if(TIMERS_ptfCallBackFuncArr[TIMER0_OVF_VECTOR_ID - CBF_OFFSET] != NULL_ptr)
	{
...
{
	if(TIMERS_ptfCallBackFuncArr[TIMER0_CTC_VECTOR_ID - CBF_OFFSET] != NULL_ptr)
	{
...
{
	if(TIMERS_ptfCallBackFuncArr[TIMER1_OVF_VECTOR_ID - CBF_OFFSET] != NULL_ptr)
	{
...
{
	if(TIMERS_ptfCallBackFuncArr[TIMER1_CTCB_VECTOR_ID - CBF_OFFSET] != NULL_ptr)
	{
...
{
	if(TIMERS_ptfCallBackFuncArr[TIMER1_CTCA_VECTOR_ID - CBF_OFFSET] != NULL_ptr)
	{
...
{
	if(TIMERS_ptfCallBackFuncArr[TIMER1_ICU_VECTOR_ID - CBF_OFFSET] != NULL_ptr)
	{
...
{
	if(TIMERS_ptfCallBackFuncArr[TIMER2_OVF_VECTOR_ID - CBF_OFFSET] != NULL_ptr)
	{
...
{
	if(TIMERS_ptfCallBackFuncArr[TIMER2_CTC_VECTOR_ID - CBF_OFFSET] != NULL_ptr)
	{
